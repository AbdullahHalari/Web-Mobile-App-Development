...
function showHistory() {
    ...
    if (msec === '') {
      ...
      document.getElementById("Records").appendChild(minRecord);
      document.getElementById("Records").appendChild(secRecord);
      document.getElementById("Records").appendChild(msecRecord);
      document.getElementById("Records").appendChild(linebreak);
    }
}